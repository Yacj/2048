...
function moveLeft() {
    ...
    for (var i =0 ; i<4;i++)
        ...
        if(board[i][j] != 0){
            for (var k = 0; k< j;k++){
                if(board[i][k] == 0 && noBlcokHorizontal(i,k,j,board)){
                ...
                else  if(board[i][k] == board[i][j] && noBlcokHorizontal(i,k,j,board) && !hasConflicted[i][k]){
                    showMoveAnimation(i,j,i,k);
                    board[i][k] += board[i][j];
                    board[i][j] = 0;
...
function moveRight() {
    ...
    for (var i =0 ; i<4;i++)
        for (var j = 2 ;j >=0 ;j--){
            if(board[i][j] != 0){
                for (var k = 3; k>j;k--){
                    if(board[i][k] == 0 && noBlcokHorizontal(i,j,k,board)){
                    ...
                    else  if(board[i][k] == board[i][j] && noBlcokHorizontal(i,j,k,board)){
                        showMoveAnimation(i,j,i,k);
                        board[i][k] *= 2;
                        board[i][j] = 0;
                        score += board[i][k];
